 ...
 */
export declare type JSCFillConfig =
	| JSCColorConfig
	| ([JSCColorConfig, boolean | number] | [JSCColorConfig, JSCColorConfig, number])
	| JSCFillConfig_object;
...
export declare interface JSCSmartPaletteConfig {
	 ...
	 */
	stops?: (
		| [number | string, JSCColorConfig, number, number]
		| [number | string, JSCColorConfig, number]
		| [number | string, JSCColorConfig]
	)[];
 ...
 * @since 2.0
 */
export declare type JSCMarginConfig =
	| number
	| ([number, number, number, number] | [number, number] | [number, number, number])
	| JSCMarginConfig_object
	| string;
...
export declare type JSCZoomConfig =
	| string
	| number
	| ([number, number] | [number, number, number] | [number, number, number, number]);
 ...
 * @inline true
 */
export declare type JSCCalendarPatternValueConfig =
	| number
	| string
	| (string | number)[]
	| JSCCalendarPatternValueConfig_object;
...
export function chart(
	targetElement: string | any,
	chartConfig: JSCChartConfig,
 ...
 * @since 1.4
 */
export function colorToPalette(
	base: JSCColorConfig,
...
export declare class Chart {
	 ...
	 */
	options(
		chartOptions?: JSCChartConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): JSCChartConfig;
	/**
	 ...
	 */
	zoom(
		zoomConfig: JSCZoomConfig,
		updateOptions?: JSCUpdateOptionsConfig
...
export declare class Point {
	 ...
	 */
	options(
		pointOptions?: JSCPointConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): Point | any;
	/**
...
export declare class Series {
	 ...
	 */
	options(
		seriesOptions?: JSCSeriesConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): Series | any;
	/**
...
export declare class Nest {
	 ...
	 */
	rollup(
		iteratee: ((entry: any) => any | string) | string,
		calculation?: 'sum' | 'average' | 'min' | 'max'
	): Nest;
	/**
...
export declare class Axis {
	 ...
	 */
	options(
		axisOptions?: JSCAxisConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): any;
	/**
...
export declare class ChartArea {
	 ...
	 */
	options(
		itemOptions?: JSCChartAreaConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): ChartArea | any;
	/**
...
export declare class Annotation {
	 ...
	 */
	options(
		itemOptions?: JSCAnnotationConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): Annotation | any;
	/**
...
export declare class Legend {
	 ...
	 */
	options(
		itemOptions?: JSCLegendConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): Legend | any;
	/**
...
export declare class AxisTick {
	 ...
	 */
	options(
		itemOptions?: JSCAxisTickConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): any;
	/**
...
export declare class AxisMarker {
	 ...
	 */
	options(
		itemOptions?: JSCAxisMarkerConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): AxisMarker | any;
	/**
...
export declare class LegendEntry {
	 ...
	 */
	options(
		itemOptions?: JSCLegendEntryConfig | string,
		updateOptions?: JSCUpdateOptionsConfig | boolean
	): LegendEntry | any;
	/**
 ...
 * @since 1.1
 */
export declare type Breaks =
	| Breaks_object
	| ([number | Date, number | Date][] | JSCCalendarPatternConfig[]);
